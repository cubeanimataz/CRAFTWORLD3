...
draw.SimpleText(text , font,x+aberration2,y+aberration2,outlinecolor,xAlign, yAlign)
draw.SimpleText(text , font,x-aberration2,y-aberration2,outlinecolor,xAlign, yAlign)
draw.SimpleText(text , font,x-aberration,y-aberration,Color(0,255,255,color.a),xAlign, yAlign)
draw.SimpleText(text , font,x+aberration,y+aberration,Color(255,0,0,color.a),xAlign, yAlign)
